...
*If you like this pacakge, please considering give it a star on [GitHub](https://github.com/jasonmoy28/psycModel). I would really appreciate that.* 

## Disclaimer:
The current release is the [alpha version](https://en.wikipedia.org/wiki/Software_release_life_cycle#Alpha) of the package. I plan to implment more features and support more models in the future (read more about planned updates [here](https://github.com/jasonmoy28/psycModel/issues/3)). If you are interested in help building this package, please feel free to submit a [pull request](https://github.com/jasonmoy28/psycModel/pulls) / [GitHub issue](https://github.com/jasonmoy28/psycModel/issues). Although I tried my best to fix any bugs, the package is not bug-free. If you find any bugs, please submit them in the [GitHub issue](https://github.com/jasonmoy28/psycModel/issues). Additionally, I highly encourage validating the output of this package with an indepedent source (e.g., SPSS, MPlus, Python). This package is liscense under the [GPLv3 liscense](https://www.gnu.org/licenses/gpl-3.0.en.html). You may use (including commercial use), re-distribute, and modified the package. However, based on the GPLv3 liscense, this pacakge also DOES NOT provide any kind of warranty, either expressed or implied. And, the authors and contributors of this package cannot be held liable for any damages inflicted by the package (including but not limited to data loss and data being rendered incorrectly). Finally, you should expect many changes that are not backward compatible until the package's first major release (i.e., v1.0.0). 
