...
#'
#' @examples
#' mediation_summary(data = lmerTest::carrots,
...
mediation_summary = function(data, 
  ...
  response_variable = data %>% dplyr::select(!!enquo(response_variable)) %>% names()
  mediator = data %>% dplyr::select(!!enquo(mediator)) %>% names()
  predictor_variable = data %>% dplyr::select(!!enquo(predictor_variable)) %>% names()
  control_variable = data %>% dplyr::select(!!enquo(control_variable)) %>% names()
  group =  data %>% dplyr::select(!!enquo(group)) %>% names()
